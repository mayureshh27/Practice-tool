    ...
    <div style={{
      ...
      <div style={{
        ...
        <div style={{display: 'flex', alignItems: 'center', gap: 12}}>
          <button
            ...
            style={{
              ...
              width: 28, height: 28, borderRadius: 'var(--ws-r-sm)',
              background: 'none', border: '1px solid var(--ws-edge-soft)',
              color: 'var(--ws-ink-2)', cursor: 'pointer'
            }}
          ...
          <div style={{display: 'flex', alignItems: 'center', gap: 8}}>
            <Settings2 size={16} style={{color: 'var(--ws-glow)'}} />
        ...
        <button 
          ...
          onClick={handleSave}
          style={{
            background: 'var(--ws-glow)', color: 'var(--ws-floor)', fontWeight: 700,
            border: 'none', borderRadius: 'var(--ws-r-md)', padding: '7px 16px',
      ...
      <div style={{
        ...
        <div style={{
          ...
          <div>
            <div style={{fontSize: 10.5, fontWeight: 700, color: 'var(--ws-ink-muted)', textTransform: 'uppercase', letterSpacing: '0.05em', marginBottom: 12}}>
              Blueprint Metadata
            </div>
            
            <div style={{display: 'flex', flexDirection: 'column', gap: 14}}>
              <div style={{display: 'flex', flexDirection: 'column', gap: 6}}>
                <label style={{fontSize: 11.5, fontWeight: 600, color: 'var(--ws-ink-2)'}}>Template Name</label>
                <input 
                  type="text" 
                  value={name}
                  onChange={e => setName(e.target.value)}
                  style={{
                    width: '100%', padding: '9px 12px', background: 'var(--ws-floor)',
                    border: '1px solid var(--ws-edge)', borderRadius: 'var(--ws-r-md)',
              ...
              <div style={{display: 'flex', flexDirection: 'column', gap: 6}}>
                <label style={{fontSize: 11.5, fontWeight: 600, color: 'var(--ws-ink-2)'}}>Target Artifact Type</label>
                <CustomSelect 
                  value={targetType}
              ...
              <div style={{display: 'flex', flexDirection: 'column', gap: 6}}>
                <label style={{fontSize: 11.5, fontWeight: 600, color: 'var(--ws-ink-2)'}}>Description</label>
                <input 
                  type="text" 
                  value={description}
          ...
          <div style={{borderTop: '1px solid var(--ws-edge-soft)', paddingTop: 20}}>
            ...
            <div style={{display: 'flex', flexDirection: 'column', gap: 10}}>
              <label style={{display: 'flex', alignItems: 'center', gap: 8, cursor: 'pointer'}}>
                ...
                <span style={{fontSize: 11.5, color: 'var(--ws-ink-2)'}}>PDF Documents</span>
              </label>
              <label style={{display: 'flex', alignItems: 'center', gap: 8, cursor: 'pointer'}}>
                ...
                <span style={{fontSize: 11.5, color: 'var(--ws-ink-2)'}}>Audio/Video Transcripts</span>
              </label>
              <label style={{display: 'flex', alignItems: 'center', gap: 8, cursor: 'pointer'}}>
                ...
                <span style={{fontSize: 11.5, color: 'var(--ws-ink-2)'}}>Markdown & Handwritten Notes</span>
              </label>
            </div>
          </div>
          ...
          <div style={{borderTop: '1px solid var(--ws-edge-soft)', paddingTop: 20}}>
            <div style={{fontSize: 10.5, fontWeight: 700, color: 'var(--ws-ink-muted)', textTransform: 'uppercase', letterSpacing: '0.05em', marginBottom: 12, display: 'flex', alignItems: 'center', gap: 6}}>
              <Shield size={12} style={{color: 'var(--ws-glow)'}} />
            ...
            <div style={{display: 'flex', flexDirection: 'column', gap: 12}}>
              <label style={{display: 'flex', alignItems: 'flex-start', gap: 10, cursor: 'pointer'}}>
                ...
                <div>
                  ...
                  <p style={{fontSize: 10, color: 'var(--ws-ink-muted)', margin: '2px 0 0', lineHeight: 1.4}}>Ensures compilation strictly conforms to target JSON formatting rules.</p>
                </div>
              </label>
              ...
              <label style={{display: 'flex', alignItems: 'flex-start', gap: 10, cursor: 'pointer'}}>
                ...
                <div>
                  ...
                  <p style={{fontSize: 10, color: 'var(--ws-ink-muted)', margin: '2px 0 0', lineHeight: 1.4}}>Executes generated equations or scripts in a isolated terminal to prevent compilation errors.</p>
                </div>
              </label>
              ...
              <label style={{display: 'flex', alignItems: 'flex-start', gap: 10, cursor: 'pointer'}}>
                ...
                <div>
                  ...
                  <p style={{fontSize: 10, color: 'var(--ws-ink-muted)', margin: '2px 0 0', lineHeight: 1.4}}>Cross-references output coordinates and facts back to linked textbook source segments.</p>
                </div>
              </label>
            </div>
          </div>
        ...
        <div style={{
          ...
          <div style={{
            ...
            <div style={{display: 'flex', alignItems: 'center', gap: 8}}>
              <FileCode2 size={14} style={{color: 'var(--ws-glow)'}} />
              <span style={{fontSize: 12.5, fontWeight: 700, color: 'var(--ws-ink)'}}>Prompt Instruction Template</span>
            </div>
            
            <div style={{display: 'flex', alignItems: 'center', gap: 6, flexWrap: 'wrap'}}>
              <span style={{fontSize: 10, color: 'var(--ws-ink-muted)', marginRight: 4}}>Insert contextual variable:</span>
              {[
                ...
                <button
                  ...
                  style={{
                    padding: '3px 8px', background: 'var(--ws-floor)', border: '1px solid var(--ws-edge-soft)',
                    borderRadius: 'var(--ws-r-sm)', color: 'var(--ws-glow)', fontSize: 9.5, fontWeight: 700,
                ...
                >
                  <span>{badge.tag}</span>
                  <span style={{fontSize: 8.5, color: 'var(--ws-ink-muted)', fontWeight: 400}}>({badge.label})</span>
                </button>
              ))}
            </div>
          </div>
          ...
          <div style={{flex: 1, position: 'relative', display: 'flex', background: 'var(--ws-floor)', overflow: 'hidden'}}>
            
            {/* Monospaced Line Number sidebar gutter */}
            <div style={{
              width: 44, background: 'var(--ws-bench)', borderRight: '1px solid var(--ws-edge-soft)',
              display: 'flex', flexDirection: 'column', alignItems: 'center', paddingTop: 16,
              color: 'var(--ws-ink-muted)', fontFamily: 'monospace', fontSize: 11, userSelect: 'none',
          ...
          <div style={{
            ...
            <div style={{
              padding: '8px 16px', background: 'var(--ws-floor)', borderBottom: '1px solid var(--ws-edge-soft)',
              display: 'flex', alignItems: 'center', gap: 6
            }}>
              <Sparkles size={11} style={{color: 'hsl(140, 60%, 45%)'}} />
              <span style={{fontSize: 10, fontWeight: 700, color: 'var(--ws-ink-muted)', textTransform: 'uppercase', letterSpacing: '0.05em'}}>
            ...
            <div style={{flex: 1, overflowY: 'auto', padding: 16}} className="scrollbar">
              <pre style={{
                ...
                color: 'var(--ws-ink-muted)', whiteSpace: 'pre-wrap', lineHeight: 1.5, background: 'none'
              }}>
                {livePreview()}
              </pre>
            </div>
